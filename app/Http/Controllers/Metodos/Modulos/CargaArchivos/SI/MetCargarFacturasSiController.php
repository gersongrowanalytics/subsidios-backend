    ...
    public function MetCargarFacturasSi(Request $request)
    {
        ...
        if (move_uploaded_file($_FILES['file']['tmp_name'], $fichero_subido)) {
            ...
            for ($i=2; $i <= $numRows; $i++) {
                ...
                $ex_solicitante      = $objPHPExcel->getActiveSheet()->getCell('A'.$i)->getCalculatedValue();
                $ex_destinatario     = $objPHPExcel->getActiveSheet()->getCell('B'.$i)->getCalculatedValue();
                $ex_material         = $objPHPExcel->getActiveSheet()->getCell('C'.$i)->getCalculatedValue();
                $ex_moneda           = $objPHPExcel->getActiveSheet()->getCell('D'.$i)->getCalculatedValue();
                $ex_clase            = $objPHPExcel->getActiveSheet()->getCell('E'.$i)->getCalculatedValue();
                $ex_fechafactura     = $objPHPExcel->getActiveSheet()->getCell('F'.$i)->getCalculatedValue();
                $ex_facturasap       = $objPHPExcel->getActiveSheet()->getCell('G'.$i)->getCalculatedValue();
                ...
                $ex_valornetodolares = $objPHPExcel->getActiveSheet()->getCell('J'.$i)->getCalculatedValue();
                $ex_pedido           = $objPHPExcel->getActiveSheet()->getCell('K'.$i)->getCalculatedValue();
                $ex_pedidooriginal   = $objPHPExcel->getActiveSheet()->getCell('L'.$i)->getCalculatedValue();
